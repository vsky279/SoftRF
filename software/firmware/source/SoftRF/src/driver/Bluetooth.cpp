...
// +	m_semaphoreWriteCharEvt.take(500, "writeValue");
// regexp
// - m_semaphore(.*?)\.take\("(.*?)"\);
// + m_semaphore$1.take\(500, "$2"\);
...
bool connectToServer() {
    ...
    pClient->connect(LXNAVDevice);  // if you pass BLEAdvertisedDevice instead of address, it will be recognized type of peer device address (public or private)
    vTaskDelay(10);
